...
void estimate_position(){
    ...
    c[1] = pow(fixed_nodes[0].distance, 2) - pow(fixed_nodes[2].distance, 2) + pow(fixed_nodes[2].x, 2) - pow(fixed_nodes[0].x, 2) + pow(fixed_nodes[2].y, 2) - pow(fixed_nodes[0].y, 2);
    // C3 = d2^2 - d3^2 + x3^2 -x2^2 + y3^2 - y2^2
    c[2] = pow(fixed_nodes[1].distance, 2) - pow(fixed_nodes[2].distance, 2) + pow(fixed_nodes[2].x, 2) - pow(fixed_nodes[1].x, 2) + pow(fixed_nodes[2].y, 2) - pow(fixed_nodes[1].y, 2);
